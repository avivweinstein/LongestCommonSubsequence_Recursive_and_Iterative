...
cout << "Test LCS using ITERATIVE method: " << len_test_it <<endl;
cout << "\n" << endl;
cout << "Test LCS is: : " << backtrack(C_test, test_X, test_Y, test_m, test_n) << endl;
int lcs_test_recursive = lcs_re(test_X, test_Y, test_m, test_n);
cout << "\n" << endl;
cout << "Test LCS using RECURSIVE method: " << lcs_test_recursive <<endl;*/
